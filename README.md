...
The snippets below pin to **`v0.0.5`**. Replace it with the version of `awsum` you have installed — plugin and compiler must match (see [Versioning](#versioning)).
...
```lua
vim.pack.add({
  { src = "https://github.com/awsum-lang/awsum-nvim", version = "v0.0.5" },
})
...
```sh
git clone --branch v0.0.5 https://github.com/awsum-lang/awsum-nvim \
...
git fetch --tags
git checkout v0.0.5.1   # or whatever new tag matches your awsum
```
